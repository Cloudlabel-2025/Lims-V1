...
export default function DoctorList() {
  ...
  const [invitationSuccess, setInvitationSuccess] = useState({ open: false, message: "", email: "" });
  ...
  const handleResendInvitation = async () => {
    ...
    try {
      ...
      setInvitationSuccess({ open: true, message: data.message, email: selectedDoctor.email });
    } catch (error) {
      ...
      {deleteModal.open && (
        <>
          ...
          <div style={{ 
            ...
            {(actionError || deleteModal.doctor?.deleteRestrictionReason) && (
              <p style={{ color: "#e11d48", fontSize: "12px", textAlign: "center", marginBottom: "12px", fontWeight: "600", padding: "0 8px" }}>
                {actionError || deleteModal.doctor?.deleteRestrictionReason}
              </p>
            )}
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <button 
                ...
                disabled={deleting || Boolean(deleteModal.doctor?.deleteRestrictionReason) || actionError === "Deletion window expired"}
                style={{ 
                  flex: 1, height: "42px", border: "none", 
                  borderRadius: "10px", 
                  background: (deleting || Boolean(deleteModal.doctor?.deleteRestrictionReason) || actionError === "Deletion window expired") ? "#cbd5e1" : "#e11d48", 
                  color: (deleting || Boolean(deleteModal.doctor?.deleteRestrictionReason) || actionError === "Deletion window expired") ? "#94a3b8" : "#fff",
                  cursor: (deleting || Boolean(deleteModal.doctor?.deleteRestrictionReason) || actionError === "Deletion window expired") ? "not-allowed" : "pointer", 
        ...
        <>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              ...
              <h3 style={{ fontSize: "18px", fontWeight: "700", color: "var(--text-primary)", margin: "0 0 8px" }}>Invitation Sent</h3>
              <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: "1.5", margin: 0 }}>
                The portal access link and OTP activation code have been sent successfully to:
              </p>
              <p style={{ fontSize: "14px", color: "var(--text-primary)", fontWeight: "700", marginTop: "8px", wordBreak: "break-all" }}>
