...
const BatchSchema = new mongoose.Schema(
  {
    ...
    supplierRef: { type: mongoose.Schema.Types.ObjectId, ref: "InventorySupplier", default: null },
...
export const InventoryItemSchema = new mongoose.Schema(
  {
    ...
    reservedBase: { type: Number, default: 0, min: 0, validate: { validator: noExponential, message: "Exponential notation is not allowed in reserved stock" } },
    ...
    // DEPRECATED — use preferredSupplierRef instead. Kept for backward compatibility.
    preferredSupplier: {
      type: String,
      trim: true,
      maxlength: 20,
    },
    preferredSupplierRef: { type: mongoose.Schema.Types.ObjectId, ref: "InventorySupplier", default: null },
    manufacturer: {
      type: String,
      trim: true,
      maxlength: 20,
    ...
    quarantineOnReceipt: { type: Boolean, default: false },
